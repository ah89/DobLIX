...
Status DBImpl::Get(const ReadOptions& read_options,
                   ...
                   std::string* value) {
  // std::cout << "GET: " << key.ToString() << " (" << key.size() << ")" << std::endl;
  // std::cout << StringSerializer::Touint64_t(key.data(), key.size(), 0) << "," << StringSerializer::Touint64_t(key.data(), key.size(), 8) << std::endl;
...
Status DBImpl::Put(const WriteOptions& o, ColumnFamilyHandle* column_family,
  ...
  // std::cout << "PUT: " << key.ToString() << " : " << val.ToString() << std::endl;  
