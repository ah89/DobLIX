...
class Footer {
 public:
  ...
  const BlockHandle& learned_index_handle() const { return learned_index_handle_; }
 
  void set_learned_index_handle(const BlockHandle& h) { learned_index_handle_ = h; }
 ...
 private:
  ...
  BlockHandle learned_index_handle_;
